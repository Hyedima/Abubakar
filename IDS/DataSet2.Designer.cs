...
namespace IDS {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class AttendanceDataTable : global::System.Data.TypedTableBase<AttendanceRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public AttendanceRow AddAttendanceRow(string regno, string fullname, string gender, string level, System.DateTime insertdate) {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public StudentsRow AddStudentsRow(string regno, string fullname, string gender, string level, System.DateTime insertdate) {
        ...
        public partial class AttendanceRow : global::System.Data.DataRow {
            ...
            public string level {
                get {
                    try {
                        return ((string)(this[this.tableAttendance.levelColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public System.DateTime insertdate {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tableStudents.insertdateColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'insertdate\' in table \'Students\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableStudents.insertdateColumn] = value;
                }
            }
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public bool IsinsertdateNull() {
                return this.IsNull(this.tableStudents.insertdateColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetinsertdateNull() {
                this[this.tableStudents.insertdateColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace IDS.DataSet2TableAdapters {
    ...
    public partial class AttendanceTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Attendance] WHERE (([regno] = @Original_regno) AND ((@IsNull_fullname = 1 AND [fullname] IS NULL) OR ([fullname] = @Original_fullname)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_level = 1 AND [level] IS NULL) OR ([level] = @Original_level)) AND ((@IsNull_insertdate = 1 AND [insertdate] IS NULL) OR ([insertdate] = @Original_insertdate)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Attendance] ([regno], [fullname], [gender], [level], [insertda" +
                "te]) VALUES (@regno, @fullname, @gender, @level, @insertdate);\r\nSELECT regno, fu" +
                "llname, gender, level, insertdate FROM Attendance WHERE (regno = @regno)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Attendance] SET [regno] = @regno, [fullname] = @fullname, [gender] = @gender, [level] = @level, [insertdate] = @insertdate WHERE (([regno] = @Original_regno) AND ((@IsNull_fullname = 1 AND [fullname] IS NULL) OR ([fullname] = @Original_fullname)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_level = 1 AND [level] IS NULL) OR ([level] = @Original_level)) AND ((@IsNull_insertdate = 1 AND [insertdate] IS NULL) OR ([insertdate] = @Original_insertdate)));
SELECT regno, fullname, gender, level, insertdate FROM Attendance WHERE (regno = @regno)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::IDS.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT regno, fullname, gender, [level], insertdate FROM dbo.Attendance";
        ...
        public virtual int Delete(string Original_regno, string Original_fullname, string Original_gender, string Original_level, global::System.Nullable<global::System.DateTime> Original_insertdate) {
        ...
        public virtual int Insert(string regno, string fullname, string gender, string level, global::System.Nullable<global::System.DateTime> insertdate) {
            if ((regno == null)) {
        ...
        public virtual int Update(string regno, string fullname, string gender, string level, global::System.Nullable<global::System.DateTime> insertdate, string Original_regno, string Original_fullname, string Original_gender, string Original_level, global::System.Nullable<global::System.DateTime> Original_insertdate) {
            if ((regno == null)) {
                throw new global::System.ArgumentNullException("regno");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fullname, string gender, string level, global::System.Nullable<global::System.DateTime> insertdate, string Original_regno, string Original_fullname, string Original_gender, string Original_level, global::System.Nullable<global::System.DateTime> Original_insertdate) {
            return this.Update(Original_regno, fullname, gender, level, insertdate, Original_regno, Original_fullname, Original_gender, Original_level, Original_insertdate);
        }
    }
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([regno], [fullname], [gender], [level], [insertdate" +
                "]) VALUES (@regno, @fullname, @gender, @level, @insertdate);\r\nSELECT regno, full" +
                "name, gender, level, insertdate FROM Students WHERE (regno = @regno)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@regno", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "regno", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@fullname", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "fullname", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@gender", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "gender", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [regno] = @regno, [fullname] = @fullname, [gender] = @gender, [level] = @level, [insertdate] = @insertdate WHERE (([regno] = @Original_regno) AND ((@IsNull_fullname = 1 AND [fullname] IS NULL) OR ([fullname] = @Original_fullname)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_level = 1 AND [level] IS NULL) OR ([level] = @Original_level)) AND ((@IsNull_insertdate = 1 AND [insertdate] IS NULL) OR ([insertdate] = @Original_insertdate)));
SELECT regno, fullname, gender, level, insertdate FROM Students WHERE (regno = @regno)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@regno", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "regno", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@fullname", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "fullname", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@gender", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "gender", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT regno, fullname, gender, [level], insertdate FROM dbo.Students";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
